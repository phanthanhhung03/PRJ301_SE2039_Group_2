            ...
            <div class="auth-card glass-panel">
                ...
                <form action="${pageContext.request.contextPath}/MainController"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" class="form-group__input" placeholder="John Smith"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="address" class="form-group__input" placeholder="123 Main Street, New York"
